...
const leadership = () => {
  return (
    ...
    <div className="container">
      <h1 className="text-center pb-4">Our Creative Team</h1>
      <p className="pl-para text-center">From poor websites that do not reflect your company. It's time to stop squandering money on bad marketing. Our Creative Team will make you seem nice, interact with your clients better, and increase your sales.</p>
