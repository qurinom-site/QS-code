        ...
        <div className="container-fluid">
            <div className="row justify-content-between mt-5">
                <div className="col-2 align-items-start align-self-start">
                    <img src={img8} alt="img1" className="ser-img-1" />
                </div>
                <div className="col-2 align-items-center align-self-center">
                    <img src={img9} alt="img2" className="se-img-2" />
                </div>
                <div className="col-2 align-items-end align-self-center">
                    <img src={img14} alt="img3" className="se-img-3" />
                </div>
            </div>
            <div className="row justify-content-center s-tr">
              <div className="col-lg-6 align-items-center align-self-center text-center">
                  ...
                  <div className="row justify-content-start">
                      <img src={img10} alt="img4" className="se-img-4 offset-8 offset-lg-1" />
                  </div>
              </div>
            ...
            <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-5 justify-content-center mt-5 mb-5">
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                            <img src={img2} className="card-img-top img-fluid se-img-7" alt="img7" />
                        </div>
                ...
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                            <img src={img3} className="card-img-top img-fluid se-img-8" alt="img8" />
                        </div>
                        <div className="card-footer align-self-center">
                ...
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                            <img src={img4} className="card-img-top img-fluid se-img-9" alt="img9" />
                        </div>
                        <div className="card-footer align-self-center">
                ...
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                            <img src={img7} className="card-img-top img-fluid se-img-12" alt="img12" /> 
                        </div>
                        <div className="card-footer align-self-center">
                ...
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                          <img src={img1} className="card-img-top img-fluid se-img-6" alt="img6" />
                        </div>
                        <div className="card-footer align-self-center">
                ...
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                            <img src={img5} className="card-img-top img-fluid se-img-10" alt="img10" />
                        </div>
                        <div className="card-footer align-self-center">
                ...
                <div className="col">
                    <div className="card h-100 se-card text-center">
                        <div className="card-body align-self-center">
                            <img src={img6} className="card-img-top img-fluid se-img-11" alt="img11" />
                        </div>
                        <div className="card-footer align-self-center">
