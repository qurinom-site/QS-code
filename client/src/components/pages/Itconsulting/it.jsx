  ...
  return (
    <>
      <div className="container">
        ...
        <p className="i-para">
        Qurinom Solution is a one-stop solution for all your difficult business concerns about IT Consultancy. We design and deliver unique, cost-effective, 
        and dependable IT Consultancy plans that will benefit your company and ensure a greater ROI.
        </p>
      </div>
        ...
        <div className="row justify-content-between">
            ...
            <div className="col-md-6 align-items-center align-self-center text-center">
              ...
              <div className="row justify-content-center mt-4">
                <div className="col-md-10 align-items-center align-self-center">
                  ...
                  Our solutions are tailored to the needs and strategies of the business.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row justify-content-between">
            <div className="col-md-6 align-items-center align-self-center text-center">
              <div className="row justify-content-center">
                <div className="col-md-10 align-items-center align-self-center">
                  <h2 className="text-capitalize">Business Architecture</h2>
                </div>
              </div>
              <div className="row justify-content-center mt-4">
                <div className="col-md-10 align-items-center align-self-center">
                  <p className="dt-ds-para">
                  We do an in-depth enterprise study before recommending target architecture and a project plan.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-md-6 align-items-center align-self-center text-center">
              <div className="row justify-content-center">
                <div className="col-md-10 align-items-center align-self-center">
                  <h2 className="text-capitalize">Architecture of Domains</h2>
                </div>
              </div>
              <div className="row justify-content-center mt-4">
                <div className="col-md-10 align-items-center align-self-center">
                  <p className="dt-ds-para">
                  Data Technology and Infrastructure, Business, Information Architecture, 
                  Application & Integration, and Security are some of our areas of competence.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="row justify-content-between">
            <div className="col-md-6 align-items-center align-self-center text-center">
              <div className="row justify-content-center">
                <div className="col-md-10 align-items-center align-self-center">
                  <h2 className="text-capitalize">Easy staff Integration</h2>
                </div>
              </div>
              <div className="row justify-content-center mt-4">
                <div className="col-md-10 align-items-center align-self-center">
                  <p className="dt-ds-para">
                  We examine the company's requirements and then outsource the best-suited applicant, 
                  guaranteeing that highly trained workers are added to the team for extraordinary outcomes.
                  </p>
                </div>
              </div>
            </div>
