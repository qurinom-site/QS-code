...
import Img12 from "../../../img/image 317.jpg";
import Img13 from "../../../img/image 316.jpg";
import Img14 from "../../../img/image 314.jpg";
import Img15 from "../../../img/image 315.jpg";
            ...
            <div className="container">
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  ...
                  <img src={Img10} className="m-img-10" alt="img" />
                  </div>
                </div>
                <div className="col-md-6 text-center">
                  <h3 className="story text-capitalize pb-3 align-self-center">story telling</h3>
                  <p className="m-para">
              ...
              <div className="row align-items-center align-self-center">
                <div className="col-md-6 text-center">
                  <h3 className="logo text-capitalize pb-3">
                ...
                <div className="col-md-6">
                  <div className="img-grp-2">
                    <img src={Img6} alt="img6" className="m-img-6" />
                  </div>
                </div>
              </div>
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="img-grp-3">
                    <img src={Img8} alt="img8" className="m-img-8" />
                  </div>{" "}
                </div>
                <div className="col-md-6 text-center">
                  <h3 className="naming text-capitalize pb-3">naming & tag lines</h3>
                  <p className="n-para">
              ...
              <div className="row align-items-center">
                <div className="col-md-6 text-center">
                  <h3 className="research text-capitalize  pb-3">
                    research & strategy
                  </h3>
                  <p className="r-para">
                ...
                <div className="col-md-6">
                  <div className="img-grp-4">
                    <img src={Img11} className="m-img-11" alt="img" />
                  </div>
                </div>
              </div>
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="img-grp-3">
                    <img src={Img12} alt="img12" className="m-img-12" />
                  </div>
                </div>
                <div className="col-md-6 text-center">
                  <h3 className="seo text-capitalize  pb-3">
                    {" "}
              ...
              <div className="row align-items-center">
                <div className="col-md-6 text-center">
                  <h3 className="smo text-capitalize  pb-3">
                ...
                <div className="col-md-6">
                  <div className="img-grp-2">
                    <img src={Img13} alt="img13" className="m-img-13" />
                  </div>
                </div>
              </div>
              ...
              <div className="row align-items-center">
                <div className="col-md-6">
                  <div className="img-grp-3">
                    <img src={Img14} alt="img14" className="m-img-14" />
                  </div>
                </div>
                <div className="col-md-6 text-center">
                  <h3 className="e-mark text-capitalize pb-3">email marketing</h3>
              ...
              <div className="row align-items-center">
                <div className="col-md-6 text-center">
                  <h3 className="graphic text-capitalize pb-3">graphic designing</h3>
                ...
                <div className="col-md-6">
                  <div className="img-grp-2">
                    <img src={Img15} alt="img15" className="m-img-15" />
                  </div>
                </div>
              </div>
              ...
              <div className="row align-items-center pb-5">
                <div className="col-md-6">
                  <div className="img-grp-3">
                    <img src={Img16} alt="img16" className="m-img-16" />
                  </div>
                </div>
                <div className="col-md-6 text-center">
                  <h3 className="inf-mark text-capitalize pb-3">
